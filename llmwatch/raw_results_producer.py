"""
llmwatch/raw_results_producer.py
(modified from llmwatch/middleware.py)
...
from bus import RawRequestEvent
from events    import get_bus, TOPIC_REQUESTS
...
class LLMWatch:
    ...
    def _tracked_call(self, messages: list, **kwargs) -> dict:
        ...
        try:
            ...
            get_bus().publish(TOPIC_REQUESTS, event)
            return response

        except Exception as exc:
            end = time.time()

            event = RawRequestEvent.error(
